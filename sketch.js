...
function preload() {
  ...
  explosionmp3 = loadSound("assets/cannon_explosion.mp3");
  watermp3 = loadSound("assets/cannon_water.mp3");
  piratemp3 = loadSound("assets/pirate_laugh.mp3");
}
